...
public final class PlausibleAnalytics
{
	...
	private static final String MOD_ID = "wi-freecam";
	 ...
	 * for sending events.
	 */
	public PlausibleAnalytics()
	{
		sessionProp("version", getVersion("wi_freecam"));
		sessionProp("short_version", getShortVersion("wi_freecam"));
